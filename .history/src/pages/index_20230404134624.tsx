        ...
        <Card styling="flex flex-col w-4/5">
          <div className="grid grid-cols-2">
            <Image
              ...
              alt={"Profile Photo"}
            />
            <Card styling="bg-green-600 mx-cover h-fit text-white p-6 m-4 flex flex-col align-self-center">
              ...
              <div className="flex flex-row flex-wrap">
                <b>Email:</b>{" "}
                <span className="ml-auto">ialejandromonasterios@gmail.com</span>
              </div>
              <div className="flex flex-row">
