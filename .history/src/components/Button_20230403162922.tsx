...
export function LinkButton({ href, styling, children }: LinkProps) {
  return (
    <Link
      href={href}
      className={`${styling} flex justify-center px-2 py-1 m-1 font-semibold bg-green-200 rounded shadow hover:bg-green-400 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700`}
    >
      {children}
    </Link>
  );
